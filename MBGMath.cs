...
namespace Assets.Scripts.Flight.Sim.MBG
{
    ...
    public static class MBGMath_CaculationMethod
    {
        ...
        private static readonly double w0 = -Math.Pow(2, 1 / 3) * h / (2 - Math.Pow(2, 1 / 3));
        private static readonly double w1 = h / (2 - Math.Pow(2, 1 / 3));
        private static readonly double w2 = h * (1 - Math.Pow(2, 1 / 3)) / (2 * (2 - Math.Pow(2, 1 / 3)));
